...
SELECT * FROM VIEW_EMP_JOB;
INSERT INTO VIEW_EMP(EMP_ID,NAME) VALUES(250,'HONG'); --EMP_ID,NAME가상열이기 때문에 INSERT불가능
...
SELECT * FROM VIEW_EMP;
UPDATE VIEW_EMP SET DEPARTMENT_ID = 100 WHERE DEPARTMENT_ID = 105;  --DEPATMENT_ID = 60 70 80이어야함
--읽기전용 뷰
CREATE OR REPLACE VIEW VIEW_EMP
AS (
    SELECT EMPLOYEE_ID,
